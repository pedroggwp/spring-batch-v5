...
public class ImprimeParImparStepConfig {
	...
	public ImprimeParImparStepConfig(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
		this.jobRepository = jobRepository;
		this.transactionManager = transactionManager;
	}

	@Bean
	Step imprimeParImparStep(ItemReader<Integer> contaAteDezReader,
